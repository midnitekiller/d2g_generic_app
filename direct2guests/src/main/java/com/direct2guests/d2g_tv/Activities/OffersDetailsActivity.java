...
public class OffersDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        offerTitle = findViewById(R.id.OfferTitle);
        offerTitle.setTypeface(fontBoldRale);
                            ...
                            for (int j = 0; j < z; j++) {
                                ...
                                for(int k = y*b; k <= v*c; k++){
                                    try{
                                        ...
                                        // Loading Font Face
                                        Typeface fontBold = Typeface.createFromAsset(getAssets(), fontPathRegCav);
                                        ...
                                        desc.setTypeface(fontBold);
                                        promoprice.setTypeface(fontBold);
                                        origprice.setTypeface(fontBold);

                                        title.setText(titlestr);
                                        desc.setText(descstr);
                                        promoprice.setText(vdata.getCurrency()+" "+promopricestr);
